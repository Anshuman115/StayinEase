...
import { updateUserProfile } from "@/store/slices/updateUserSlice";
...
const Profile = () => {
  ...
  console.log("data of user to update is", data);

  const { user: userData, success, error, isLoading: loading } = data;
